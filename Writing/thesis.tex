...
\centering
\begin{tabular}{l|cccc|}
\begin{tabular}{c} Test\\subject \end{tabular} &
\begin{tabular}{c} Mean\\absolute\\error \end{tabular} & 
\begin{tabular}{c} Root\\mean\\squared\\error \end{tabular} & 
\begin{tabular}{c} Samples\\in\\forest \end{tabular} & 
\begin{tabular}{c} Samples\\in\\dungeon \end{tabular} \\
\hline
Jan & 1.1235 & 1.5402 & 13 & 14 \\ \hline
Sjo & 1.4125 & 1.7272 & 10 & 11 \\ \hline
3 & 0.963 & 1.1089 & 11 & 10 \\ \hline
4 & 7 & 7 & 7 & 7 \\ \hline
\end{tabular}
\captionof{table}{Generalizability to new settings}
