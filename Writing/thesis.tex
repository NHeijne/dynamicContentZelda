...
\subsection{Accuracy}
The following figures were obtained using Weka \cite{weka}.
...
\end{tabular}
\captionof{figure}{Accuracy of the estimator}
\end{table*}
...
\begin{tabular}{c} Root\\mean\\squared\\error \end{tabular} \\
\hline
Jan & 1.1369 & 1.5545 & 7 & 7 \\ \hline
2 & 7 & 7 & 7 & 7 \\ \hline
3 & 7 & 7 & 7 & 7 \\ \hline
4 & 7 & 7 & 7 & 7 \\ \hline
\end{tabular}
\captionof{figure}{Generalizability to multiple settings}
\end{table*}
