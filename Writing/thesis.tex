...
\captionof{figure}{The interaction of the systems as they were used during the experiment. Rectangular boxes denote discrete pieces of data being passed between the systems; the other elements are models which parse and generate data (even the player can be viewed as such). Note that the method by which the builder and the player generate data is constantly updated while the estimator is static.}
\end{figure*}
...
%linear values can cause rooms to clog up.
