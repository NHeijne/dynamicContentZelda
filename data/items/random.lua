...
local item_list = {{ "rupee", 1 }, { "bomb", 1 }, { "arrow", 1 },{ "arrow", 1 }, { "heart", 1}, { "magic_flask", 1}, {nil, 1}, {nil, 1}, {nil, 1}, {nil, 1} }
...
function item:choose_item_from_list()
  if #item_list == 0 then 
  	item_list = {{ "rupee", 1 }, { "bomb", 1 }, { "arrow", 1 }, { "heart", 1}, { "magic_flask", 1}, { "arrow", 1 }, { "arrow", 1 }, {nil, 1}, {nil, 1}, {nil, 1} }
  end
